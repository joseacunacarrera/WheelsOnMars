...
public:
    Genetic(int pPopulationNumber, std::vector<std::vector<Range>> *pTorqueTable, std::vector<std::vector<Range>> *pFoldingTable, std::vector<int> *pFoldingEnergyTable, std::vector<int> *pTorqueEnergyTable, Tierra *pSection)
    {
